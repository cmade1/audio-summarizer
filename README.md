...
- Vite build ile static hosting
- Otomatik CI/CD pipeline
- Environment variables: Vercel dashboard'da ayarlanır

### Backend Deployment (Render)
- Node.js web service
- `vercel.json` ile serverless functions konfigürasyonu
- FFmpeg binary'leri otomatik kurulum
- Environment variables: Render dashboard'da ayarlanır
